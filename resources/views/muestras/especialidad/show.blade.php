...
<div class="container-fluid"  background="{{asset('img/Fondo2.jpg')}}">
    <div >
     <div class='row'>
      <div class='col'><h1 class="text-white-25"> {{$especialidad}} </h1> 
          ...
          <tbody>
            ...
            @endif
               ...
               <td @if($e->description=='') class='focoso' @endif> {{$e->description}}</td>
                ...
                <a href="{{route('llamar_especialidad',[$e->cuenta,$e->especialidad])}}"> <button class="boton-oscuro"> <i class="fa fa-phone" aria-hidden="true"> </i> &nbsp; LLAMAR </button></a>             
              </td>
            </tr>
            @endforeach
          </tbody>
