...
writer = pd.ExcelWriter('storage/reporte_individual_act2014.xlsx', engine='xlsxwriter')
...
worksheet.merge_range('C4:H4', 'CONSECUTIVO ENCUESTAS ACTUALIZACION 2014', negro_b)
